...
func main() {
	...
	http.HandleFunc("/remove/", func(w http.ResponseWriter, r *http.Request) {
		...
		dirName := "/home/ljy/Desktop/grid-home/home/source/proxy/userdata/workspace-" + uuidFromUrl
	...
	http.HandleFunc("/copy/", func(w http.ResponseWriter, r *http.Request) {
		...
		if err1 != nil || err2 != nil {
			...
			if _, err := os.Stat(dirName); !os.IsNotExist(err) {
				...
				newDirName := "/home/ljy/Desktop/grid-home/home/source/proxy/userdata/workspace-" + newUuid
	...
	http.HandleFunc("/initialize", func(w http.ResponseWriter, r *http.Request) {
		...
		dirName = "/home/ljy/Desktop/grid-home/home/source/proxy/userdata/workspace-" + uuidString
		...
		if _, ok := usersessions[uuidString]; !ok {
			...
			ws.GoCmd = exec.Command("/bin/sh", "-c", "go run *.go -addr=:"+strconv.Itoa(ws.Port)+" -root=/home/ljy/Desktop/grid-home/home/source/proxy/userdata/workspace-"+uuidString+"/")
			ws.GoCmd.Dir = "/home/ljy/Desktop/grid-home/home/source/"
			ws.GoCmd.Stdout = outfile
			ws.GoCmd.Stderr = outfile

			ws.NodeCmd = exec.Command("node", "app.js", strconv.Itoa(ws.TermPort), "/home/ljy/Desktop/grid-home/home/source/proxy/userdata/workspace-"+uuidString+"/")
			ws.NodeCmd.Dir = "/home/ljy/Desktop/grid-home/home/run/terminal-server/"
